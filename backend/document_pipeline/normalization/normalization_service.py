class ClauseNormalizationService:
    """Normalizes extracted clauses while preserving vector DB citations and policy text."""
    ...
    def normalize_clauses(self, raw_clauses: list) -> list:
        ...
        for c in raw_clauses:
            ...
            normalized.append({
                ...
                "confidence_score": float(c.get("confidence_score") or 0.95),
                ...
                "rag_reference_used": str(c.get("rag_reference_used") or "N/A"),
